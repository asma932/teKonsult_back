const getOrders = require('../Controller/orders.controller');
...
adminRouter.get('/allOrders', auth, getOrders.getOrders);
adminRouter.post('/addOrder', auth, addOrder.addOrder);
adminRouter.get('/myOrders', auth, addOrder.getUserOrders);
